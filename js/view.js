(function() {
    ...
    function renderProduct(productTitle, imgSrc, price, rankAverage, rankCount) {
        return  createElement('section', {class: "product"},
                    [
                        createElement('div', {class: "cover-container"},
                            createElement('img', {class: "cover", src: imgSrc})    
                        ),
                        ...
                        createElement('h4', {class: "price"},
                            [
                                price,
                                createElement('span', {class: "unit"}, ' تومان')
                            ]
                        )
                    ]
                )
        ...
        for (var i = 0; i < pages; i++) {
            if(i + 1 === currentActivePage) {
                pageInsertionNode.appendChild(
                    createElement('li', {class: "page-active"}, createElement('a', {href: "#", 'data-page': i + 1}, i + 1))
                );
            }
            else{
                pageInsertionNode.appendChild(
                    createElement('li', {}, createElement('a', {href: "#", 'data-page': i + 1}, i + 1))
                );
            }
